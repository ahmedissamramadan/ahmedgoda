...
const ImageComparisonSlider = ({
  ...
  return (
    ...
    >
      ...
      {/* labels */}
      <div className="absolute top-4 right-4 glass-dark text-white px-3.5 py-1.5 rounded-full text-xs font-bold tracking-wide flex items-center gap-2">
        <span className="w-2 h-2 rounded-full bg-white/90 animate-pulse" />
        {beforeLabel}
      </div>
      <div className="absolute top-4 left-4 bg-accent text-accent-foreground px-3.5 py-1.5 rounded-full text-xs font-bold shadow-md border border-white/20">
        {afterLabel}
      </div>
