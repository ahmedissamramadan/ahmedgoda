      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">شهادات من عملاء سابقين عن تجربتهم مع المهندس أحمد جوده</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <TestimonialCard
              quote="تعاملت مع المهندس أحمد في تشطيب شقتي بالتجمع الخامس. الراجل محترم جداً وملتزم بالمواعيد. كان بيبعتلي صور يومية للشغل وبيستشيرني في كل تفصيلة. النتيجة النهائية فاقت توقعاتي والحمد لله."
              name="م. خالد عبدالرحمن"
              location="التجمع الخامس"
              projectType="تشطيب شقة 180 متر"
            />
            <TestimonialCard
              quote="من أحسن القرارات اللي اتخذتها إني اتعاملت مع شركة المهندس أحمد جوده. الشغل نظيف والخامات ممتازة. أهم حاجة إنه صادق ومفيش مفاجآت في الميزانية. الضمان المكتوب أداني ثقة كبيرة."
              name="د. نورهان السيد"
              location="الشيخ زايد"
              projectType="تشطيب فيلا 350 متر"
            />
            <TestimonialCard
              quote="شطّبت محلي التجاري معاه وسلّمه قبل الموعد بأسبوع! العمال محترمين ونظافة الموقع كانت ممتازة أثناء التنفيذ. أنصح أي حد بالتعامل معاه."
              name="أ. محمود فاروق"
              location="مدينة نصر"
              projectType="تجهيز محل تجاري"
            />
            <TestimonialCard
              quote="المهندس أحمد فاهم شغله كويس جداً. ساعدني أختار التصميم المناسب لميزانيتي من غير ما يضغط عليّا. التواصل كان سهل والمتابعة مستمرة. الشقة طلعت أحلى مما كنت متخيل."
              name="أ. أحمد حسن"
              location="المعادي"
              projectType="تشطيب شقة 150 متر"
            />
            <TestimonialCard
              quote="اتعاملت مع أكتر من مقاول قبل كده وكانت تجارب سيئة. لكن المهندس أحمد جوده فرق معايا. التزام بالكلمة، جودة عالية، وسعر عادل. الحمام والمطبخ طلعوا تحفة والجيران بيسألوني عن المقاول."
              name="م. سارة عبدالله"
              location="القاهرة الجديدة"
              projectType="تجديد حمام ومطبخ"
            />
            <TestimonialCard
              quote="أنا مش ساكن في مصر وكنت قلقان أشطّب شقتي من بره. المهندس أحمد طمّني وكان بيبعتلي تقارير فيديو أسبوعية. سلّم الشقة زي ما اتفقنا بالظبط وأنا مبسوط جداً."
              name="أ. ياسر المصري"
              location="التجمع الخامس"
              projectType="تشطيب شقة 200 متر (من الخارج)"
            />
          </div>
        </div>
      </section>
